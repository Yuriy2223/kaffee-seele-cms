      ...
      {links.map(({ id, label }, index) => {
        ...
        return (
          <button
            ...
            className={clsx(
              'relative text-xl transition-all duration-700 ease-spring',
              isMobile
                ? 'opacity-0 translate-y-4 group-[.is-open]:opacity-100 group-[.is-open]:translate-y-0'
                : '',
              ...
              variant === 'mobile' &&
                'text-left py-4 px-6 w-full border-b border-warm-brown/5 last:border-0 active:bg-sage-green/5',

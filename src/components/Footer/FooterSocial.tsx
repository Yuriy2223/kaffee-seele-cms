  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <p className={`text-warm-white/80 text-sm sm:text-base leading-relaxed transition-all duration-1000 ease-[var(--ease-spring)] delay-100 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>

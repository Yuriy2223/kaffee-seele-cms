...
export const FooterContacts = () => {
  ...
  if (isLoading || !contacts) return (
    <div
      ref={ref as React.RefObject<HTMLDivElement>}
      className={`md:col-span-1 space-y-6 transition-all duration-1000 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
    >
  ...
  return (
    ...
    >
      <h4 className={`text-lg sm:text-xl font-semibold text-warm-white border-b border-warm-white/30 pb-2 text-center transition-all duration-1000 ease-[var(--ease-spring)] ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
        Контакти
      </h4>

      <div className="space-y-3">
        <div className={`bg-warm-white/8 rounded-lg p-3 sm:p-4 border border-warm-white/10 transition-all duration-1000 ease-[var(--ease-spring)] delay-100 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
        ...
        <div className={`bg-warm-white/8 rounded-lg p-3 sm:p-4 border border-warm-white/10 hover:bg-warm-white/12 transition-colors duration-200 transition-all duration-1000 ease-[var(--ease-spring)] delay-200 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
        ...
        <div className={`bg-warm-white/8 rounded-lg p-3 sm:p-4 border border-warm-white/10 hover:bg-warm-white/12 transition-colors duration-200 transition-all duration-1000 ease-[var(--ease-spring)] delay-300 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-warm-white/15 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className={`bg-warm-white/8 rounded-lg p-3 sm:p-4 border border-warm-white/10 hover:bg-warm-white/12 transition-colors duration-200 transition-all duration-1000 ease-[var(--ease-spring)] delay-400 ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-warm-white/15 rounded-lg flex items-center justify-center flex-shrink-0">

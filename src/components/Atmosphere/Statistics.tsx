      ...
      {statsData.map((stat, index) => (
        ...
        >
          <div className="flex items-center justify-center mb-3">
            <div className="w-10 h-10 bg-linear-to-br from-sage-green to-warm-brown rounded-full flex items-center justify-center shadow-md transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
              {stat.icon}
            </div>
          </div>
